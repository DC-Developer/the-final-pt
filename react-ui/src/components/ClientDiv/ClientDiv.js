...
const ClientDiv = (props) => {
    ...
    <div>
        ...
        <div className="client">
            <div className="clientName">{props.fullname}</div> <div className="clientDate">{props.date}</div> <EditModal clientData={props.clientData} saveClient={props.saveClient} id={props.key}/>
        </div>
    </div>
    );
}
